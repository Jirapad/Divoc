...
class ListMDDialog(BaseDialog):
    Hospital_name = StringProperty("Missing data")
    Phone_number = StringProperty("Missing data")
    Street_address = StringProperty("Missing data")
    Suburb = StringProperty("Missing data")
    Postcode = StringProperty("Missing data")
    state = StringProperty("Missing data")
    LHN = StringProperty("Missing data")
    PHNa = StringProperty("Missing data")
    Website = StringProperty("Missing data")
    Description = StringProperty("Missing data")
    Sector = StringProperty("Missing data")
    Beds = StringProperty("Missing data")
